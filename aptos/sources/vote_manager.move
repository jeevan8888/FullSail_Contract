module fullsail::vote_manager {
    ...
    public entry fun initialize() {
        ...
        let admin_data = AdministrativeData{
            ...
            operator: @0xc3bb8488ab1a5815a9d543d7e41b0e0df46a7396f89b22821f07a4362f75ddc5,
            governance: @0xc3bb8488ab1a5815a9d543d7e41b0e0df46a7396f89b22821f07a4362f75ddc5,
    ...
    public entry fun claim_rewards<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(
        ...
        let rewards = fullsail::rewards_pool::claim_rewards(ve_token_addr, fees_pool, epoch_id);
        let incentive_pool = incentive_pool(liquidity_pool);
        vector::append<fungible_asset::FungibleAsset>(&mut rewards, fullsail::rewards_pool::claim_rewards(ve_token_addr, incentive_pool, epoch_id));
    ...
    public entry fun vote(
        ...
        let total_weight = 0;
        let weights_temp = copy weights;
        vector::reverse<u64>(&mut weights_temp);
        let weight_count = vector::length<u64>(&weights_temp);
        while (weight_count > 0) {
            total_weight = total_weight + vector::pop_back<u64>(&mut weights_temp);
            weight_count = weight_count - 1;
        };
        vector::destroy_empty<u64>(weights_temp);
